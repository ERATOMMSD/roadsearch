...
class VirtualRoadsGenerator(AbstractGenerator):
    ...
    def __init__(self, time_budget=None, executor=None, map_size=None,
                 ...
                 strict_father=True, random_budget=3600,
        ...
        super().__init__(time_budget=time_budget, executor=executor, map_size=map_size,
                         generator=generator, strict_father=strict_father, store_data=store_data)
    ...
    def evolve(self):
        ...
        while self.is_time_available():
            ...
            if parent is not None and self.mutator_defined(parent.outcome.item()):
                ...
                self.df.at[parent.index, 'visited'] = 1
